...
module.exports = {
    VERSION: 'v7.3.6',
    CHANNEL: 'https://chat.whatsapp.com/IwypalWoEKhDWeQcmbf3Bc',
    SESSION: process.env.ASENA_SESSION === undefined ? '' : process.env.KINGDC_SESSION,
    ...
    XTEAM_API: process.env.XTEAM_API === undefined ?'Db2251ba8836d521' : process.env.XTEAM_API,
